	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-12" id="hero" style="height:50px; margin:60px 0 60px 0; padding:0;">
				...
				<h2>Pengurusan surat, aduan masyarakat, dan informasi Desa Siluman.</h2>
			</div>
			<div class="col-md-6 col-lg-4">
				<div class="feature-block">
					<a href="<?= base_url("surat") ?>">
						...
						<p>Layanan berbagai kebutuhan pengurusan surat warga Desa Siluman.</p>
					</a>
			...
			<div class="col-md-6 col-lg-4">
				<div class="feature-block">
					<a href="<?= base_url("pengaduan/buat_pengaduan") ?>">
						...
						<p>Layanan pengaduan keluhan warga Desa Siluman.</p>
					</a>
			...
			<div class="col-md-6 col-lg-4">
				<div class="feature-block">
					<a href="<?= base_url("potensi/detail") ?>">
						...
						<h4>Potensi Desa</h4>
						<p>Menampilkan profil dan informasi potensi Desa Siluman.</p>
					</a>
		...
		<div class="row pb-5 px-5 mt-3" style="background:rgba(0, 0, 0, 0.8);">
			<div class="col-md-12 pt-3" id="hero" style="height:50px; margin:10px 0 60px 0;">
				...
				<h2 class="text-light">Informasi mengenai berita dan kegiatan di Desa Siluman.</h2>
			</div>
		...
		<div class="row">
			<div class="col-md-12" id="hero" style="height:50px; margin:10px 0 60px 0; padding:0;">
				...
				<h2>Berikut daftar aspirasi/keluhan warga Desa Siluman.</h2>
			</div>
