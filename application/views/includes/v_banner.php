<section id="herobanner" class="wow fadeIn text-center">
  ...
  -webkit-text-stroke-color: white;">Welcome to Desa Siluman</h1>
          ...
          <img class="img-slide" style="width:100vw; height:100vh; opacity:0.8;" src="<?= base_url() ?>assets/img/desasiluman.jpeg" alt="First slide">
        </div>
