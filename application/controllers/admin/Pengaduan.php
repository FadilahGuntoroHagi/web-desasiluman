...
class Pengaduan extends CI_Controller
{
	...
	function cetak($id)
	{
		...
		$data['element'] .= "<h4 style='margin-top:-8px;' class='text-center'>DESA SILUMAN KECAMATAN PABUARAN</h4>";
		$data['element'] .= "</div>";
		...
		$data['element'] .= '<h5 for="">Desa Siluman, ' . date("d M Y", strtotime($hasil->tgl_pengaduan)) . '</h5>';
