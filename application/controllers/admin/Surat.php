...
class Surat extends CI_Controller
{
	...
	function cetak($surat, $id)
	{
		...
		$data['element'] .= "<h5 style='margin-top:-8px;' class='text-center'>Jl.Raya Siluman Kode Pos 41262  - Telp. 085-894407494 Fax. 031-880880</h5>";
		...
		if ($surat == 'kelahiran') {
			...
			if ($hasil->jenis == "usaha") {
				$data['element'] .= '</tbody>';
				$data['element'] .= '</table>';
				$data['element'] .= "<p>Yang bersangkutan benar-benar warga Desa Siluman yang memiliki usaha:";
