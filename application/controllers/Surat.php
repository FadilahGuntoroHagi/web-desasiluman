...
class Surat extends CI_Controller
{
	...
	function cetak($surat, $nik, $id)
	{
		...
		$data['element'] .= "<h4 class='text-center'><strong>PEMERINTAH KABUPATEN SUBANG</strong></h4>";
		$data['element'] .= "<h4 style='margin-top:-8px;' class='text-center'><strong>KECAMATAN PABUARAN</strong></h4>";
		$data['element'] .= "<h4 style='font-size:20px; margin-top:-8px; font-weight:bold;' class='text-center'>KANTOR DESA SILUMAN</h4>";
		$data['element'] .= "<h5 style='margin-top:-8px;' class='text-center'>Jl. Raya Siluman Kode Pos 4126 - Telp. 085-894407494 Fax. 031-880880</h5>";
		$data['element'] .= "<h5 style='margin-top:-8px;' class='text-center'>SUBANG - 61261</h5>";
		$data['element'] .= "</div>";
		$data['element'] .= "<div style='padding-bottom:20px; width:3cm; margin-right:20px;' class='pull-right'>";
		$data['element'] .= "<img src='" . base_url("assets/img/favicon5.png") . "' style='width:3cm;'>";
		...
		$data['element'] .= "<p>Saya yang bertanda di bawah ini selaku Kepala Desa Siluman, dengan ini menerangkan bahwa:</p>";
		...
		if ($surat == 'kelahiran') {
			...
			$data['element'] .= '<td style="border:none;">: Desa Siluman, RW ' . $hasil->rw . ', RT ' . $hasil->rt . '</td>';
			$data['element'] .= '</tr>';
			$data['element'] .= '</tbody>';
			$data['element'] .= '</table>';
		} elseif ($surat == 'kematian') {
			...
			$data['element'] .= '</tbody>';
			$data['element'] .= '</table>';
			$data['element'] .= "<p>Yang bersangkutan benar-benar warga Desa Siluman yang tidak mampu untuk melakukan pembayaran $hasil->tujuan.</p><br/>";
		} elseif ($surat == 'biodata') {
			...
			$data['element'] .= '</tbody>';
			$data['element'] .= '</table>';
			$data['element'] .= "<p>Yang bersangkutan benar-benar warga Desa Siluman yang memiliki anggota keluarga sebagai berikut:.</p><br/>";
			$data['element'] .= '<table class="table table-borderless">';
			$data['element'] .= '<tbody>';
			$data['element'] .= "
			<tr>
			...
			$data['element'] .= '</tbody>';
			$data['element'] .= '</table>';
			$data['element'] .= "<p>Yang bersangkutan benar-benar warga Desa Siluman sedang $hasil->tujuan.</p><br/>";
		} elseif ($surat == "domisili") {
			...
			if ($hasil->jenis == "usaha") {
				$data['element'] .= '</tbody>';
				$data['element'] .= '</table>';
				$data['element'] .= "<p>Yang bersangkutan benar-benar warga Desa Siluman yang memiliki usaha bernama $hasil->nama_usaha, yang beralamat di $hasil->alamat.</p><br/>";
			} else {
				$data['element'] .= '<tr>';
				...
				$data['element'] .= '</tbody>';
				$data['element'] .= '</table>';
				$data['element'] .= "<p>Yang bersangkutan benar-benar warga yang berdomisili di Desa Siluman.</p><br/>";
			}
		}
		...
		$data['element'] .= '<h5 for="">Desa Siluman, ' . date("d M Y") . '</h5>';
		...
		$data['element'] .= "</div>";
		$data['element'] .= '<h5><strong>Warman, S.T, M.H</strong></h5>';
		$data['element'] .= '</div>';
