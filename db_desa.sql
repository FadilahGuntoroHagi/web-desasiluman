...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 07, 2022 at 08:40 AM
...
(11, 'Harga Ikan Naik Pedagang Menangis', '<p>Saat Menjelang bulan suci Ramadhan&nbsp;harga pokok makanan naik sehingga menyebabkan kenaikan bahan baku makanan bagi ibu rumah tangga dan UMKM, begitupun dengan kenaikan harga Ikan....&nbsp;</p>\r\n', '2022-06-07 13:17:16', 'umkm', './assets/img/berita/123456789-1654582635-cover_file.jpg', 1, '123456789'),
(12, 'Kerusakan Jalan di Desa Siluman', '<p>kerusakan jalan di Desa Siluman menyebabkan akses jalan warga terhambat</p>\r\n', '2022-06-07 13:20:21', 'umum', './assets/img/berita/123456789-1654582821-cover_file.jpg', 1, '123456789'),
(13, 'Banjir di Daerah Pabuaran', '<p>Akibat hujan deras beberapa desa di Kecamatan Pabuaran, Subang mengalami banjir</p>\r\n', '2022-06-07 13:21:59', 'umum', './assets/img/berita/123456789-1654582919-cover_file.jpeg', 1, '123456789');
...
(1, 'Makmur Jaya', 'perdagangan', 'Saaye', '2016-11-30', '085832749723', '', 'http://localhost/webdesa/assets/img/bumdes/123456-1593068105-logo_file.png', -1);
...
(2, '2/I/16/6/2020', 'tetangga', '2015-03-12', 'Ijam', 'L', 1, 'Ijam', 'Ajim', 'Jami', '', 8, 3, '2020-06-17 01:01:20', NULL, '', '', '', '', '', '123456', './assets/img/sign/601cb624ce347.png', ''),
...
(9, '472.11/3/438.7.9.14/', 'anak', '2022-05-18', 'Subang', 'L', 2, 'Ujang Sudrajat', 'Dayat Sudrajat', 'Siti Nurhasanah', '', 1, 2, '2022-05-26 13:53:12', NULL, '', './assets/img/surat/kelahiran/123456789-1653547991-ket_file.jpg', './assets/img/surat/kelahiran/123456789-1653547991-kk_file.jpg', './assets/img/surat/kelahiran/123456789-1653547991-ktp_file.jpg', './assets/img/surat/kelahiran/123456789-1653547991-buku_file.jpg', '123456789', '', '');
...
(3, '472.12/1/438.7.9.14/', 'tetangga', '1346677', 'uwhhwj', '2018-03-01', 'L', 'hindu', 'cerai_mati', 'petani', 'wni', '2022-06-03', 'rumah', 'Kanker', 'Keluarga', '', 'wswd5t4hyhjujuyj', '2022-05-23 13:15:01', NULL, './assets/img/surat/kematian/123456-1653286500-pernyataan_file.jpg', './assets/img/surat/kematian/123456-1653286501-ktp_file.jpg', './assets/img/surat/kematian/123456-1653286500-kk_file.jpg', './assets/img/surat/kematian/123456-1653286501-ktp_alm_file.jpg', './assets/img/surat/kematian/123456-1653286501-kk_alm_file.jpg', 2, '123456', '', ''),
(4, '472.12/2/438.7.9.14/', 'anak', '1346677', 'sisia', '2022-05-01', 'P', 'islam', 'belum', 'petani', 'wni', '2022-05-24', 'rumah', 'Kanker', 'Keluarga', '', 'aassws', '2022-05-24 14:17:08', NULL, './assets/img/surat/kematian/123456-1653376627-pernyataan_file.jpg', './assets/img/surat/kematian/123456-1653376628-ktp_file.jpg', './assets/img/surat/kematian/123456-1653376628-kk_file.jpg', './assets/img/surat/kematian/123456-1653376628-ktp_alm_file.jpg', './assets/img/surat/kematian/123456-1653376628-kk_alm_file.jpg', 0, '123456', '', '');
...
(1, 'Toko Mantap Jiwa', 'kelontong', '165150201111134', '085832749723', 'RT06/RW02', '2022-04-27', '', 'http://localhost/webdesa/assets/img/umkm/123456-1593069339-logo_file.jpg', 0);
...
('111222', 'Fadilah Guntoro Hagi', 'hadgie100@gmail.com', '$2y$10$xIFj4n8fXSRZ1S9CJwupVO1j8veT66CqcMmAYkNHQy.7zkk2bQ0vO', 'Subang', '2022-05-21', '085894407494', '', 1, 2, 'l', 'a', 'islam', 'sd', 'petani', '', 1, 0, './assets/img/warga/ktp/111222-1653112910-ktp_file.jpg', './assets/img/warga/kk/111222-1653112910-kk_file.jpg', './assets/img/warga/foto/111222-1653112910-foto_file.jpg'),
('123456', 'Khafido', 'ilzam@gmail.com', '$2y$10$1E9TplgvnUlnGQqIHl4jMuI/hJP4bmLFr8OGI3KW.Ule8WHfuXucG', 'Subang', '1998-08-29', '085646433651', '', 4, 2, 'l', 'b', 'islam', 's1', 'pelajar', '', 1, 1, './assets/img/warga/ktp/123456-1613817183-ktp_file.png', '1591623610-kk.png', './assets/img/warga/foto/123456-1613817305-foto_file.png'),
('123456789', 'Dayat Sudrajat', 'dayat123@gmail.com', '$2y$10$8.sXNCgzpOuPxR9ztLz/BuS9uz8LEDv2PVbdZvq.Ti3bjG9idsblG', 'subang', '2022-05-26', '085992205555', '', 0, 0, 'l', 'a', 'islam', 'sd', 'petani', 'belum', 1, 0, '', '', ''),
('16515020', 'Khafido Ilzam', 'khafemail@gmail.com', '$2y$10$i/xF1dJ7Fg3vKEhW4DSmYuHhTqWtsrnIWL40AF1QD/kImuSQD4IN.', 'Subang', '2015-01-06', '085230839313', '', 4, 2, 'l', 'ab', 'islam', 'slta', 'swasta', '', 0, 3, '', '', './assets/img/warga/foto/16515020-1604642344-foto_file.png'),
('165150201111134', 'Muchamad Khafido Ilzam', 'khaf@gmail.com', '$2y$10$41B81e5tXWar7GnNSQUo5eLex3z.SOPuesbddFRPBU.Zr2XSWBBC2', 'Subang', '2007-02-12', '08593753289', '', 4, 3, 'l', 'o', 'kristen', 's1', 'wiraswasta', '', 0, 0, './assets/img/warga/ktp/165150201111134-1592312875-ktp_file.jpg', './assets/img/warga/kk/165150201111134-1592312875-kk_file.png', './assets/img/warga/foto/165150201111134-1592312875-foto_file.png'),
('215123551464646', 'Ilzam', 'khaf2@gmail.com', '$2y$10$xsEjU/NXze9ekJwgBoluGeNKZw2adPiYULq4bPE3Z5zXhsjE3E/I6', 'Subang', '2008-03-11', '0856672483', '', 5, 1, 'l', 'o', 'kristen', 's2', 'pns', '', 0, 0, '', '', ''),
('222222', 'Kepala Desa', 'kepala@gmail.com', '$2y$10$99ZkSVB4jG3nD1bIbF6J2uF.cM87uoal1lL3.fagPfqy5WbzLPQt6', 'Subang', '2021-02-20', '08583924', '', 2, 1, 'l', 'a', 'islam', 'sd', 'petani', '', 1, 0, './assets/img/warga/ktp/default.jpg', '', './assets/img/warga/foto/222222-1614051018-foto_file.png'),
